package com.example.movieapp.androidApp.base.util;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.movieapp.androidApp.base.util.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.movieapp.androidApp.base.util.GlideOptions().apply(toSet));
    }
  }
}
